...
typedef int_fast8_t s8;   ///<  8-bit signed integer
typedef int_fast16_t s16; ///< 16-bit signed integer
typedef int_fast32_t s32; ///< 32-bit signed integer
typedef int_fast64_t s64; ///< 64-bit signed integer
